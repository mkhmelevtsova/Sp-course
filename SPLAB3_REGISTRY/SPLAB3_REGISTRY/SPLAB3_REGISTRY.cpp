...
INT PrintSubkeysList();
INT PrintKeyParametres();
INT SearchString();
...
int main(int argc, LPTSTR argv[])
{
    ...
    while (true) {
        ...
        switch (option)
        {
            case 1:
            {
                INT result = PrintSubkeysList();
                break;
            }
            case 2:
            {
                INT result = PrintKeyParametres();
                break;
            }
            case 3:
            {
                INT result = SearchString();
                break;
            }
            case 4:
            {
...
INT PrintSubkeysList()
{
    ...
    if (initialSection == NULL) return -1;
    ...
    else
    {
        ...
        {
            dwValue = 256;
            subkeyResultCode = RegEnumKeyEx(hKey, dwIndex, subkeyName, &dwValue, NULL, NULL, NULL, NULL);//выводим папки
    ...
    else
    {
        ...
        do
        {
            ...
            if (subkeyResultCode == ERROR_SUCCESS)
            {
                ...
                {
                case 3: parameterTypeN = (LPTSTR)L"REG_BINARY"; break;
                case 4: parameterTypeN = (LPTSTR)L"REG_DWORD"; break;
                case 5: parameterTypeN = (LPTSTR)L"REG_REG_DWORD_BIG_ENDIAN"; break;
                case 2: parameterTypeN = (LPTSTR)L"REG_EXPAND_SZ"; break;
                case 6: parameterTypeN = (LPTSTR)L"REG_LINK"; break;
                case 7: parameterTypeN = (LPTSTR)L"REG_MULTI_SZ"; break;
                case 0: parameterTypeN = (LPTSTR)L"REG_NONE"; break;
                case 8: parameterTypeN = (LPTSTR)L"REG_RESOURCE_LIST "; break;
                case 1: parameterTypeN = (LPTSTR)L"REG_SZ"; break;
...
void KeyAnalyser(HKEY initialSection, TCHAR keyPath[], LPTSTR searchValue)
 {
    ...
    else
    {
        ...
        {
            dwValueForKey = 256;
            subkeyResultCode = RegEnumKeyEx(hKey, dwIndexForKey, subkeyName, &dwValueForKey, NULL, NULL, NULL, NULL);//выводим папки
            if (subkeyResultCode == ERROR_SUCCESS)
            {
